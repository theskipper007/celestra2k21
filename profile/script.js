...
const dashboard = (array) => {
  ...
  array.forEach((info) => {
    ...
    const insideHtml = ` <h1 class="first-name"> ${name} </h1> 
      <p>Welcome to Extrofest 3.0, This is your dashboard. Here at Extrofest 3.0 our users matters us the most!💙</p>
      <h2>Information</h2>
     <p>
          College : ${college}
          <br>
...
const event = (array) => {
  if (array.length === 0)
    e.innerHTML = `<a href="https://Extrofest 3.0fest.netlify.app/#timeline_anchor" class="btn">Register to Events</a>`;
...
const pronite = (array) => {
  if (array.length === 0)
    p.innerHTML = `<a href="https://Extrofest 3.0fest.netlify.app/#pronites_anchor" class="btn">Register to Pronites</a>`;
